...
router.register(r'api/dataViews', viewSet.DataViewViewSet)
...
urlpatterns = [
    ...
    url(r'^api/queryStores/',  views.queryStores),
    ...
    url(r'^api/updateDataView/',  views.updateDataView),
    ...
    url(r'^api/addMaterialToStore/',  views.addMaterialToStore),
    url(r'^api/queryPoweranaChart/',  views.queryPoweranaChart),
    url(r'^api/queryInterviewChart/',  views.queryInterviewChart),
    url(r'^api/addMaterialToStoreResult/',  views.addMaterialToStoreResult),
